...
class SignalementActionAdapter (private var signalements: List<Signalement>) :
    RecyclerView.Adapter<SignalementActionAdapter.SignalementViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SignalementViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.signalement_item_action, parent, false)
